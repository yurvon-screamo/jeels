...
**Furigana dependency.** If furigana is always visible, you read the reading without ever recalling the kanji. You finish the volume and recognize zero new kanji. If you hide furigana, you can't read at all yet. There's no middle state unless the tool tracks which kanji you've learned and hides furigana only on those.
...
- **OCR is good, not perfect.** Hand-drawn or heavily stylized kanji can fail recognition. You'll occasionally need to correct by hand.
