---
title: "How Many Kanji Do You Actually Need: Honest Numbers"
slug: /blog/how-many-kanji-to-learn
locale: en
meta_title: "How Many Kanji You Need to Know: Real Numbers (2026)"
meta_description: "The 2,136 jōyō kanji are not your goal. Real thresholds per task: manga with furigana, web articles, newspapers. Why 'knowing kanji' is the wrong question and how to measure progress."
target_keywords: ["how many kanji to learn", "how many kanji do you need", "kanji by jlpt level", "kanji needed to read manga"]
lastmod: 2026-08-23
...
The JLPT institute publishes no official kanji or vocabulary lists at any level. Every table saying "N5 ≈ 100, N1 ≈ 2000" is teacher consensus reconstructed from analysis of past exams. Treat all figures below with that caveat; discrepancies of ±20% between sources are normal.

## Thresholds Per Task

| Task | Estimated kanji | Rough level |
| --- | --- | --- |
| Manga with full furigana (shōnen, slice of life) | 100–300 | N5–N4 |
| Everyday dialogue, captions, menus | 200–400 | N4 |
| Web articles, simple stories | ~700–1000 | N3 |
...
**Furigana is scaffolding, not a permanent crutch.** The right dynamic: furigana shows on unknown characters and hides on learned ones, forcing recall. Reading stays comfortable while memory load grows with your vocabulary.
...
1. **Text coverage.** Take a page of your target material and count familiar words. 90%+ reads pleasantly; 70% is heavy but productive.
2. **Learned-vocabulary counter.** If your app tracks cards in the "learned" state, that's a direct estimate of your lexicon.
3. **JLPT practice tests.** Indirect but standardized.
...
### Do I need all 2,136 jōyō?

Only if you're aiming at newspapers, business correspondence, or N1. For furigana manga, anime, and everyday conversation, a few hundred suffice.

### How many kanji can I realistically learn per day?

Through words: 5–10 new words daily is a sustainable pace that grows your kanji count as a side effect. Grinding 20 bare characters a day produces a nice counter and empty memory a month later.

### Do learned kanji fade?

Yes, without review. Spaced repetition keeps them active on stretching intervals; only regular reading locks anything in "permanently."
