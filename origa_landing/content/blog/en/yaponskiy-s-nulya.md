---
title: "Japanese from Zero: A Realistic Self-Study Plan to Start"
...
### Stage 1. Kana (1–2 weeks)

Hiragana and katakana are the two syllabaries. There are 46 + 46 of them; two weeks is a normal pace. Without them, reading a textbook is impossible.

- Don't try to learn them together with kanji. Kana first, as a separate block.
- Train writing, not only recognition. Tracing each one 5–10 times fixes it in memory.
- Use a trainer with spaced repetition. Looking at the table once does not work.

A typical mistake is learning hiragana and dropping katakana because hiragana appears more often at the start of textbooks. Katakana catches up with you in week three, when loanwords start showing up in texts: コーヒー (coffee), テレビ (TV), スマートフォン (smartphone). Learn both syllabaries together.

### Stage 2. Basic grammar and first words (2–3 months)

After the kana, the language itself begins: how a sentence is built, how verbs conjugate, how particles は, が, を, に, で work.

- Pick one grammar resource and follow it sequentially. Don't jump between three textbooks.
- In parallel, start a dictionary and spaced repetition. Grammar without vocabulary doesn't work.
- The goal of this stage is to understand simple sentences like "I went to the store yesterday" and to build your own within the bounds of N5.

Good textbooks at this stage: Minna no Nihongo (みんなの日本語), Genki, Tae Kim's Grammar Guide. The downside of Minna is that you typically need to buy a separate book for grammatical commentary in your native language. The upside is strict structure and level alignment.

### Stage 3. Kanji and N5 (3–6 months)

Kanji is the scariest part for a European learner. 2136 jōyō (common-use) characters is a lot. The main advice: **don't try to learn all kanji from a list.** Learn the ones that appear in the texts you read.

- Order matters less than it seems. WaniKani's radical-based approach works, but it isn't the only path.
- Tie each kanji to words in which it appears. A single kanji can be read dozens of ways across different words; studying "the reading of a kanji" in a vacuum is nearly useless.
- The goal is to pass N5 (or an equivalent by self-assessment). That's about 100 kanji and 800 words.
...
- This is usually where the need for a tool that links "see it in content" to "study it in SRS" appears.

## The main beginner mistakes

**Studying the language, not skills.** "I'm studying Japanese" is too vague. Split it up: reading, listening, writing, speaking. At the start, focus on reading and listening; speaking is better deferred until N4, otherwise you risk cementing wrong pronunciation.
...
**Ignoring listening.** If you only read and write, after a year you won't understand a word of native speech. Listening is a separate skill; it has to be trained from the start, even if you only catch 20%.
