---
title: "Phrases and Listening in Origa"
slug: /docs/phrases
locale: en
meta_title: "Phrases and Listening in Origa — Native Sentences, N+1 Selection"
meta_description: "How phrases work in Origa: a corpus of native Japanese sentences with original audio, automatic selection at your level, and listening practice."
target_keywords: ["japanese listening practice", "japanese phrases app", "japanese immersion", "japanese sentence practice", "native japanese audio"]
lastmod: 2026-07-23
status: ready
---
...
# Phrases and listening

Origa includes a corpus of phrases pulled from native Japanese content. This page covers where the phrases come from, how they are selected for you, and how listening practice works.
...
When phrases enter your lessons, Origa selects ones that sit slightly above your current level. The principle is **N+1**: each new phrase should contain mostly words you already know, with one or two new ones. This keeps the cognitive load manageable while still pushing you forward.

Selection is driven by your known-vocabulary index. As you learn more words, the pool of phrases Origa can offer widens.
