...
pub static CONTENT: Content = Content {
    ...
    faq_a1: "Start from the built-in bilingual dictionaries in your own language. Create a card from a word, a sentence, a photo, or an audio clip; Origa adds furigana, takes it through a short presentation and training round, and schedules reviews with FSRS spaced repetition. If you are new to the language, begin at JLPT N5.",
