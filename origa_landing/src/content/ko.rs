...
pub static CONTENT: Content = Content {
    ...
    faq_a1: "사용자 언어의 내장 다국어 사전으로 시작하세요. 단어, 문장, 사진, 음성에서 카드를 만들면 Origa가 후리가나를 추가하고, 짧은 소개와 훈련을 거치게 한 뒤 FSRS 알고리즘으로 복습 일정을 잡아줍니다. 처음이라면 JLPT N5부터 시작하세요.",
