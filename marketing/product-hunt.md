# Origa — Product Hunt Launch Materials

## Status: Draft (not ready for launch)

---

## Tagline

**Anki + Bunpro + WaniKani in your own language** (43 chars)

Alternatives:

- "All Japanese learning tools in your native language" (47)
- "Japanese learning, all-in-one, in your language" (44)
- "Learn Japanese in your own language" (36)
...
Interface is currently available in English and Russian, with Vietnamese, Korean and Indonesian coming soon.
...
- [ ] Problem slide ("the old way" of learning Japanese)
- [ ] Feature demo (specific feature showcase)
- [ ] Social proof (user count, reviews, etc.)
- [ ] Video demo (60 sec)
...
- 0 users (project in development)
- Need to collect beta feedback before launch

---

## Pricing

- Free and open-source (BSL 1.1)
- Paid features planned in the future (don't communicate this to consumers)
