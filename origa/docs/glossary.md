...
Карточки-компаньоны [companion vocab cards] — словарные карточки, автоматически создаваемые для кандзи (популярные слова, содержащие этот иероглиф). Максимум `MAX_COMPANION_WORDS` (3) на кандзи.
